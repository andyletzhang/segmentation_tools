...
class MainWidget(QMainWindow):
    def __init__(self):
        ...
        toolbar_layout.addItem(QSpacerItem(*self.spacer, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed))
    ...
    def calibrate_cell_diameter(self):
        ...
        diam, style_diam=self.size_model.eval(self.frame.img)
        self.cell_diameter.setText(str(diam))

        print('Calibrating cell diameter')

    def segment_frame(self):
        print('Segmenting frame')
    ...
    def add_RGB_checkboxes(self, layout):
        ...
        self.show_grayscale.setChecked(False)
        layout.addSpacerItem(QSpacerItem(*self.spacer, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed))
