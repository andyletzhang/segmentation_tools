...
class LeftToolbar(QScrollArea):
    ...
    def _create_normalize_widget(self):
        ...
        for button in (self.normalize_frame_button, self.normalize_stack_button, self.normalize_custom_button):
    ...
    def _create_voxel_size_widget(self):
        ...
        for label, input_field in [('XY:', self.xy_size_input), ('Z:', self.z_size_input)]:
    ...
    def get_segmentation_tab(self):
        ...
        ROIs_LUTs_layout=QHBoxLayout()
        self.ROIs_label = QLabel('0 ROIs', self)
        self.apply_LUTs_checkbox = QCheckBox('Apply LUTs', self)
        ROIs_LUTs_layout.addWidget(self.ROIs_label)
        ROIs_LUTs_layout.addWidget(self.apply_LUTs_checkbox)
        ...
        segment_frame_layout.addLayout(ROIs_LUTs_layout)
    ...
    def get_FUCCI_tab(self):
        ...
        self.red_threshold_input.setValidator(QDoubleValidator(bottom=0))  # non-negative floats only
        ...
        self.green_threshold_input.setValidator(QDoubleValidator(bottom=0))  # non-negative floats only
        ...
        self.percent_threshold_input.setValidator(QDoubleValidator(bottom=0))  # non-negative floats only
    ...
    def get_volumes_tab(self):
        ...
        float_01_validator = QDoubleValidator(bottom=0, top=1)
        float_01_validator.setNotation(QDoubleValidator.StandardNotation)
        self.peak_prominence.setValidator(float_01_validator)
        ...
        self.coverslip_prominence.setValidator(float_01_validator)
...
class RightToolbar:
    ...
    def _create_scroll_area(self):
        ...
        scroll_area.setSizePolicy(QSizePolicy.Policy.MinimumExpanding, QSizePolicy.Policy.Preferred)
    ...
    def _create_stat_overlay(self):
        ...
        # Slider section
        slider_layout, self.stat_LUT_slider, self.stat_range_labels = labeled_LUT_slider(default_range=(0, 255), parent=self)
        layout.addLayout(slider_layout)
